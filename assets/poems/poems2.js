...
export default class Poems2 {
    ...
    poems2() {
        let data =
            [
                { id: "a-menacing-knight", img: "aMenacingKnight.jpg", title: "A Menacing Knight", poem: this.aMenacingKnight, audio: "aMenacingKnight.wav" },
                { id: "a-stranger", img: "aStranger.jpg", title: "A Stranger", poem: this.aStranger, audio: "aStranger.wav" },
                { id: "wind-paints", img: "windPaints.jpg", title: "Wind Paints", poem: this.windPaints, audio: "windPaints.wav" },
                { id: "birds", img: "birds.jpg", title: "Birds", poem: this.birds, audio: "birds.wav" },
                { id: "boundaries-are-drawn", img: "boundariesAreDrawn.jpg", title: "Boundaries are Drawn", poem: this.boundariesAreDrawn, audio: "boundariesAreDrawn.wav" },
                { id: "chase-after-the-mystery", img: "chaseAfterTheMystery.jpg", title: "Chase After the Mystery", poem: this.chaseAfterTheMystery, audio: "chaseAfterTheMystery.wav" },
                { id: "across-the-universe", img: "acrossTheUniverse.jpg", title: "Across the Universe", poem: this.acrossTheUniverse, audio: "acrossTheUniverse.wav" },
                { id: "i-feel-differently", img: "iFeelDifferently.jpg", title: "I Feel Differently", poem: this.iFeelDifferently, audio: "iFeelDifferently.wav" },
                { id: "let-the-water", img: "letTheWater.jpg", title: "Let the Water", poem: this.letTheWater, audio: "letTheWater.wav" },
                { id: "and-what", img: "andWhat.jpg", title: "And What", poem: this.andWhat, audio: "andWhat.wav" },
                { id: "hops-vines", img: "hopsVines.jpg", title: "Hops Vines", poem: this.hopsVines, audio: "hopsVines.wav" },
                { id: "a-man-walking-alone", img: "aManWalkingAlone.jpg", title: "A Man Walking Alone", poem: this.aManWalkingAlone, audio: "aManWalkingAlone.wav" },
                { id: "a-thousand", img: "aThousand.jpg", title: "A Thousand", poem: this.aThousand, audio: "aThousand.wav" },
                { id: "earth", img: "earth.jpg", title: "Earth", poem: this.earth, audio: "earth.wav" },
                { id: "i-refuse", img: "iRefuse.jpg", title: "I Refuse", poem: this.iRefuse, audio: "iRefuse.wav" },
                { id: "he-ran", img: "heRan.jpg", title: "He Ran", poem: this.heRan, audio: "heRan.wav" },
                { id: "the-great-desire", img: "theGreatDesire.jpg", title: "The Great Desire", poem: this.theGreatDesire, audio: "theGreatDesire.wav" },
                { id: "thunder-storms", img: "thunderStorms.jpg", title: "Thunder Storms", poem: this.thunderStorms, audio: "thunderStorms.wav" },
                { id: "you-will-know-me", img: "youWillKnowMe.jpg", title: "You Will Know Me", poem: this.youWillKnowMe, audio: "youWillKnowMe.wav" },
                { id: "canyon-alpenglow", img: "canyonAlpenglow.jpg", title: "Canyon Alpenglow", poem: this.canyonAlpenglow, audio: "canyonAlpenglow.wav" },
                { id: "unexpected-departure", img: "unexpectedDeparture.jpg", title: "Unexpected Departure", poem: this.unexpectedDeparture, audio: "unexpectedDeparture.wav" },
                { id: "desert-determination", img: "desertDetermination.jpg", title: "Desert Determination", poem: this.desertDetermination, audio: "desertDetermination.wav" },
                { id: "born-in-dry-desert", img: "bornInDryDesert.jpg", title: "Born in Dry Desert", poem: this.bornInDryDesert, audio: "bornInDryDesert.wav" },
                { id: "first-raindrops", img: "firstRaindrops.jpg", title: "First Raindrops", poem: this.firstRaindrops, audio: "firstRaindrops.wav" },
                { id: "right-now", img: "rightNow.jpg", title: "Right Now", poem: this.rightNow, audio: "rightNow.wav" },
                { id: "objective-view", img: "objectiveView.jpg", title: "Objective View", poem: this.objectiveView, audio: "objectiveView.wav" },
                { id: "live-poetically", img: "livePoetically.jpg", title: "Live Poetically", poem: this.livePoetically, audio: "livePoetically.wav" },
